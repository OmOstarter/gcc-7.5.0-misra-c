...
//char name_before[20]; 
void misra_c_header_name(cpp_reader *pfile, _cpp_file *file,source_location loc)
{
static char name_before[20];
if(strcmp(file->name, name_before) !=0 )
 {
...
{
  char *path;
	//extern bool Wmisra_cpp_trigger;
	if(CPP_OPTION(pfile,Wmisra_cpp_trigger))
 		 misra_c_header_name(pfile,file,loc);                                     //misra-c
